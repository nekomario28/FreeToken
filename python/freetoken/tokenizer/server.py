            ...
            if len(detokenize_msg) > 0:
                ...
                sampled_replies = [
                    UserReply(
                        ...
                        moe_layer_calls=msg.moe_layer_calls,
                        moe_active_experts=msg.moe_active_experts,
                        moe_missing_experts=msg.moe_missing_experts,
                        moe_fetched_experts=msg.moe_fetched_experts,
                    )
