...
def _index_by_bank_layer(model_path: str, config, spec: Any):
    ...
    by_layer: dict[int, dict[str, list]] = collections.defaultdict(
...
def stream_nvfp4_layers_serial(
    ...
    *,
    ...
    for bank_layer in range(num_layers):
        ...
        # The sink owns/releases ``banks`` before it returns. No reference to their tensors
        # is retained here when the next layer is allocated.
